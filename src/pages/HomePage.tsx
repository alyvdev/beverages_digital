...
import { StockChangeTable, TickerTape } from "@/components/home";
      ...
      <main className="flex-1">
        ...
        <section className="py-12 md:py-20 mb-12 relative overflow-hidden">
          <div className="container-responsive relative z-10">
            <div
              className={`grid gap-12 items-center transition-all duration-500 ${
                isTableFullscreen ? "grid-cols-1" : "grid-cols-1 lg:grid-cols-2"
              }`}
            >
              {!isTableFullscreen && (
                <div className="animate-fade-in">
                  ...
                  <p className="text-lg text-muted-foreground mb-8 max-w-lg">
                    Discover our unique menu where prices adjust based on
                    popularity and demand. The more popular an item, the higher
                    its coefficient - reflecting its true market value.
                  </p>
        ...
        {/* Ticker Tape Section - Full Width */}
        <TickerTape />

        {/* Menu Section */}
        <section id="menu-section" className="container-responsive py-6">
          <MenuList />
        </section>
      </main>
      ...
      <footer className="bg-card border-t border-border py-8 mt-auto transition-colors duration-300">
        <div className="container-responsive">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground max-w-xs">
                Enjoy our premium selection of beverates with dynamic pricing
          ...
          <div className="border-t border-border mt-8 pt-6 text-center">
            <p className="text-sm text-muted-foreground">
              © 2025 Beverates Digital. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
